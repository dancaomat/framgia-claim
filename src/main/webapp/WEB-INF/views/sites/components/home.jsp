...
<div id="cmsmasters_row_qvofd9wtbf" class="cmsmasters_row cmsmasters_color_scheme_default cmsmasters_row_top_default cmsmasters_row_bot_default cmsmasters_row_boxed">
    <div class="cmsmasters_row_outer_parent">
        <div class="cmsmasters_row_outer">
            <div class="cmsmasters_row_inner">
                <div class="cmsmasters_row_margin">
                    <div id="cmsmasters_column_2s1lsnigz6" class="cmsmasters_column one_fourth">
                        <div class="cmsmasters_column_inner">
                            <div id="cmsmasters_heading_2xrsyawps" class="cmsmasters_heading_wrap cmsmasters_heading_align_left">
                                <h5 class="cmsmasters_heading">Partners:</h5>
                            </div>
                        </div>
                    </div>
                    <div id="cmsmasters_column_hs3xh68jdn" class="cmsmasters_column three_fourth">
                        <div class="cmsmasters_column_inner">
                            <div class="cmsmasters_clients_slider_wrap">
                                <div id="cmsmasters_clients_jabnwnoaz" class="cmsmasters_owl_slider owl-carousel cmsmasters_clients_slider" data-items="5" data-single-item="false" data-auto-play="false" data-slide-speed="1000" data-pagination-speed="1000" data-pagination="false" data-navigation="false">
                                    <div class="cmsmasters_clients_item item cmsmasters_owl_slider_item"><img src='<c:url value="/resources/sites/uploads/2015/11/4.png"/>' alt="CBCM" title="CBCM" /></div>
                                    <div class="cmsmasters_clients_item item cmsmasters_owl_slider_item"><img src='<c:url value="/resources/sites/uploads/2015/11/2.png"/>' alt="Hoop" title="Hoop" /></div>
                                    <div class="cmsmasters_clients_item item cmsmasters_owl_slider_item"><img src='<c:url value="/resources/sites/uploads/2015/11/5.png"/>' alt="Envato" title="Envato" /></div>
                                    <div class="cmsmasters_clients_item item cmsmasters_owl_slider_item"><img src='<c:url value="/resources/sites/uploads/2015/11/3.png"/>' alt="jQuery" title="jQuery" /></div>
                                    <div class="cmsmasters_clients_item item cmsmasters_owl_slider_item"><img src='<c:url value="/resources/sites/uploads/2015/11/1.png"/>' alt="Citibank" title="Citibank" /></div>
                                </div>
                            </div>
                        </div>
                    </div>
...
<div id="cmsmasters_row_58algoulbe" class="cmsmasters_row cmsmasters_color_scheme_default cmsmasters_row_top_default cmsmasters_row_bot_default cmsmasters_row_boxed">
    <div class="cmsmasters_row_outer_parent">
        <div class="cmsmasters_row_outer">
            <div class="cmsmasters_row_inner">
                <div class="cmsmasters_row_margin">
                    <div id="cmsmasters_column_6xuokl84w" class="cmsmasters_column one_first">
                        <div class="cmsmasters_column_inner">
                            <div id="cmsmasters_divider_sw1kap1e7" class="cmsmasters_divider cmsmasters_divider_width_long cmsmasters_divider_pos_center"></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="cmsmasters_row_inner">
                <div class="cmsmasters_row_margin">
                    <div id="cmsmasters_column_lsov3ybw8" class="cmsmasters_column one_first">
                        <div class="cmsmasters_column_inner">
                            <div id="cmsmasters_heading_d87q1pelsm" class="cmsmasters_heading_wrap cmsmasters_heading_align_center">
                                <h2 class="cmsmasters_heading">Presenting products and services that are right for you</h2>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="cmsmasters_row_inner">
                <div class="cmsmasters_row_margin">
                    <div id="cmsmasters_column_z99sxwzcb5" class="cmsmasters_column one_fourth">
                        <div class="cmsmasters_column_inner">
                            <div id="cmsmasters_icon_l3lewy05o" class="cmsmasters_icon_wrap"><span class="cmsmasters_simple_icon cmsmasters-icon-custom-bank-mac"></span><span class="cmsmasters_simple_icon_title"></span></div>
                            ...
                            <div id="cmsmasters_heading_1ejwb2v4m" class="cmsmasters_heading_wrap cmsmasters_heading_align_left">
                                <h5 class="cmsmasters_heading"><a href="contacts/index.html">Apply online</a></h5>
                            </div>
                        </div>
                    </div>
                    <div id="cmsmasters_column_xc6tcas1bl" class="cmsmasters_column one_fourth">
                        <div class="cmsmasters_column_inner">
                            <div id="cmsmasters_icon_a2addw8sa" class="cmsmasters_icon_wrap"><span class="cmsmasters_simple_icon cmsmasters-icon-custom-brief-bag"></span><span class="cmsmasters_simple_icon_title"></span></div>
                            ...
                            <div id="cmsmasters_heading_q7nk55q6bc" class="cmsmasters_heading_wrap cmsmasters_heading_align_left">
                                <h5 class="cmsmasters_heading"><a href="contacts/index.html">Take the first step </a></h5>
                            </div>
                        </div>
                    </div>
                    <div id="cmsmasters_column_4exif1a1so" class="cmsmasters_column one_fourth">
                        <div class="cmsmasters_column_inner">
                            <div id="cmsmasters_icon_hczzh1504s" class="cmsmasters_icon_wrap"><span class="cmsmasters_simple_icon cmsmasters-icon-custom-phone"></span><span class="cmsmasters_simple_icon_title"></span></div>
                            <div id="cmsmasters_heading_ae8zeg9ozk" class="cmsmasters_heading_wrap cmsmasters_heading_align_left">
                                <h2 class="cmsmasters_heading">Mobile Bank</h2>
                            </div>
                            <div class="cmsmasters_text">
                                <p>Explore the power of simpler and smarter banking. Bank online with over 250 services</p>
                            </div>
                            <div id="cmsmasters_heading_0sp1akl6ye" class="cmsmasters_heading_wrap cmsmasters_heading_align_left">
                                <h5 class="cmsmasters_heading"><a href="services/index.html">Find out more</a></h5>
                            </div>
                        </div>
                    </div>
                    <div id="cmsmasters_column_yeyi5m4ssk" class="cmsmasters_column one_fourth">
                        <div class="cmsmasters_column_inner">
                            <div id="cmsmasters_icon_8jvixerxni" class="cmsmasters_icon_wrap"><span class="cmsmasters_simple_icon cmsmasters-icon-custom-secure"></span><span class="cmsmasters_simple_icon_title"></span></div>
                            <div id="cmsmasters_heading_eolsafm9pk" class="cmsmasters_heading_wrap cmsmasters_heading_align_left">
                                <h2 class="cmsmasters_heading">Online Deposit</h2>
                            </div>
                            <div class="cmsmasters_text">
                                <p>Explore the power of simpler and smarter banking. Bank online with over 250 services</p>
                            </div>
                            <div id="cmsmasters_heading_gnssf1lvrp" class="cmsmasters_heading_wrap cmsmasters_heading_align_left">
                                <h5 class="cmsmasters_heading"><a href="services/index.html">Learn more</a></h5>
                            </div>
                        </div>
                    </div>
                </div>
...
<div id="cmsmasters_row_zec15ew0eg" class="cmsmasters_row cmsmasters_color_scheme_default cmsmasters_row_top_default cmsmasters_row_bot_default cmsmasters_row_boxed">
    <div class="cmsmasters_row_outer_parent">
        <div class="cmsmasters_row_outer">
            <div class="cmsmasters_row_inner">
                <div class="cmsmasters_row_margin">
                    <div id="cmsmasters_column_gnmjkub59e" class="cmsmasters_column one_half">
                        <div class="cmsmasters_column_inner">
                            <div id="cmsmasters_heading_8iw44myj5" class="cmsmasters_heading_wrap cmsmasters_heading_align_left">
                                <h6 class="cmsmasters_heading">ALISTER BANK MOBILE APP</h6>
                            </div>
                            <div id="cmsmasters_fb_c7ztytkol" class="cmsmasters_featured_block">
                                <div class="featured_block_inner">
                                    <div class="featured_block_text">
                                        <div id="cmsmasters_heading_856eoonb1q" class="cmsmasters_heading_wrap cmsmasters_heading_align_left">
                            ...
                            <div class="cmsmasters_text">
                                <p><span style="color: #6a6a6b; font-size: 18px; line-height: 28px; font-weight: 300;">Download the Alister Bank app and simplify your banking. Discover quick, simple and convenient way to take command of your bank account, on your mobile phone.</span></p>
                            </div>
                            <div id="cmsmasters_divider_kilx4n7juc" class="cl"></div>
                            <div class="cmsmasters_img  cmsmasters_image_l cmsmasters_image_mb"><a href="#"><img src='<c:url value="/resources/sites/uploads/2015/11/appstore.png"/>' alt="appstore" /></a></div>
                            <div class="cmsmasters_img  cmsmasters_image_l"><a href="#"><img src='<c:url value="/resources/sites/uploads/2015/11/google-play.png"/>' alt="google-play" /></a></div>
                        </div>
                    </div>
                    <div id="cmsmasters_column_bcxr4qx81c" class="cmsmasters_column one_half">
                        <div class="cmsmasters_column_inner">
                        </div>
                    </div>
                </div>
...
<div id="cmsmasters_row_gb7mnu8mab" class="cmsmasters_row cmsmasters_color_scheme_default cmsmasters_row_top_default cmsmasters_row_bot_default cmsmasters_row_fullwidth">
    <div class="cmsmasters_row_outer_parent">
        <div class="cmsmasters_row_outer">
            <div class="cmsmasters_row_inner cmsmasters_row_fullwidth cmsmasters_row_no_margin">
                <div class="cmsmasters_row_margin cmsmasters_row_columns_behavior">
                    <div id="cmsmasters_column_l4nkfxibb" class="cmsmasters_column one_half">
                        <div class="cmsmasters_column_inner">
                        	<img src='<c:url value="/resources/sites/uploads/2015/11/4.jpg"/>' />
                        </div>
                    </div>
                    <div id="cmsmasters_column_d3prux8f68" class="cmsmasters_column one_half">
                        <div class="cmsmasters_column_inner">
                            <div id="cmsmasters_heading_ugbup3onys" class="cmsmasters_heading_wrap cmsmasters_heading_align_left">
                                <h5 class="cmsmasters_heading">LEARNING CENTER</h5>
                            </div>
                            <div id="cmsmasters_heading_cp6x6xlf0g" class="cmsmasters_heading_wrap cmsmasters_heading_align_left">
                                <h2 class="cmsmasters_heading">Making internet a brand new experience</h2>
                            </div>
                            <div class="cmsmasters_text">
                                <p><span style="color: #ffffff; font-size: 18px; line-height: 28px; font-weight: 300;">Online banking can save you a lot of time and effort, you can undertake most transactions from the comforts of your home. However, it is crucial to use internet banking safely</span></p>
                            </div>
                            <div id="cmsmasters_divider_3008f8e93h" class="cl"></div>
                            <div id="cmsmasters_button_gy0lflhjtn" class="button_wrap"><a href="blog/index.html" class="cmsmasters_button"><span>Learn more</span></a></div>
                        </div>
                    </div>
                </div>
            </div>
